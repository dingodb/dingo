...
public class DingoScanWithRelOpRule extends ConverterRule {
    public static final Config DEFAULT = Config.INSTANCE
        .withConversion(
            LogicalScanWithRelOp.class,
            Convention.NONE,
            DingoConvention.INSTANCE,
            "DingoScanWithCalcRule"
        )
        .withRuleFactory(DingoScanWithRelOpRule::new);

    protected DingoScanWithRelOpRule(Config config) {
        super(config);
    }

    @Override
    public RelNode convert(RelNode rel) {
        LogicalScanWithRelOp scan = (LogicalScanWithRelOp) rel;
