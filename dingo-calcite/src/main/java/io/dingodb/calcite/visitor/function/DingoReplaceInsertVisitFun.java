...
public final class DingoReplaceInsertVisitFun {
    private DingoReplaceInsertVisitFun() {
    }
                    ...
                    if (transaction != null) {
                        ...
                        if (pessimisticTxn) {
                            ...
                            if (transaction.getPrimaryKeyLock() == null) {
                                ...
                                PessimisticLockReplaceIntoParam pessimisticLockParam = new PessimisticLockReplaceIntoParam(
                                    tableId,
                                    td.tupleType(),
                                    td.keyMapping(),
                                    transaction.getIsolationLevel(),
                                ...
                                lockVertex = new Vertex(PESSIMISTIC_LOCK_REPLACE_INTO, pessimisticLockParam);
                            }
                            ...
                            Vertex insertVertex = new Vertex(TXN_PART_REPLACE_INTO,
                                new TxnPartReplaceIntoParam(
                                    tableId,
                                    td.tupleType(),
                                    td.keyMapping(),
                                    true,
                            ...
                            vertex = new Vertex(TXN_PART_REPLACE_INTO,
                                new TxnPartReplaceIntoParam(
                                    tableId,
                                    td.tupleType(),
                                    td.keyMapping(),
