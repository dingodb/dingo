...
public class SqlShowStatus extends SqlShow {
    public String sqlLikePattern;

    private static final SqlOperator OPERATOR = new SqlSpecialOperator("SHOW STATUS", SqlKind.SELECT);
     ...
     * @param pos      pos
     */
    public SqlShowStatus(SqlParserPos pos, String sqlLikePattern) {
        super(OPERATOR, pos);
