...
public enum DingoSqlTypeFamily implements RelDataTypeFamily {
    // Primary families.
    CHARACTER,
    BINARY,
    NUMERIC,
    ...
    private static final Map<Integer, DingoSqlTypeFamily> JDBC_TYPE_TO_FAMILY =
        ImmutableMap.<Integer, DingoSqlTypeFamily>builder()
            // Not present:
     ...
     */
    public static @Nullable DingoSqlTypeFamily getFamilyForJdbcType(int jdbcType) {
    ...
    public List<DingoSqlTypeFamily> allowableDifferenceTypes() {
        switch (this) {
            case NUMERIC:
    ...
    public @Nullable RelDataType getDefaultConcreteType(RelDataTypeFactory factory) {
        switch (this) {
            ...
            case NUMERIC:
                return DingoSqlTypeUtil.getMaxPrecisionScaleDecimal(factory);
            case DATE:
