...
pub fn ffi_search_in_rowid_range(
    ...
    search_in_rowid_range(&index_path, &query, lrange, rrange, use_regex)
}
...
pub fn ffi_count_in_rowid_range(
    ...
    count_in_rowid_range(&index_path, &query, lrange, rrange, use_regex)
}
...
pub fn ffi_bm25_search_with_filter(
    ...
    bm25_search_with_filter(&index_path, &query, &u8_bitmap, top_k, need_text)
}
...
pub fn ffi_bm25_search(
    ...
    bm25_search(&index_path, &query, top_k, need_text)
}
...
pub fn ffi_search_bitmap_results(
    ...
    search_bitmap_results(&index_path, &query, use_regex)
}
