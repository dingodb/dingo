...
//         tantivy_writer_commit, tantivy_writer_free, FFI_INDEX_WRITER_CACHE,
//     };

//     fn commit_some_docs_for_test(
...
//             index_writer_bridge.index.clone(),
//         )
//     }
...
//             .path()
//             .to_str()
//             .expect("Can't convert temp directory to temp directory_str");
...
//         let result = tantivy_create_index_with_tokenizer(
//             index_directory_cxx,
//             tokenizer_with_parameter_cxx,
//             false,
//         );
//         assert!(result.is_ok());
...
//         let_cxx_string!(
//             index_directory = temp_directory
//                 .path()
//                 .to_str()
//                 .expect("Can't convert temp directory to temp directory_str")
//         );
...
//         assert!(tantivy_create_index_with_tokenizer(
//             index_directory_cxx,
//             tokenizer_with_parameter_cxx,
//             false
//         )
...
//             .parse_query("Ancient")
//             .expect("Can't parse query");
//         let searched_bitmap_1 = searcher
//             .search(&text_query, &row_id_collector)
//             .expect("Can't execute search.");
//         assert_eq!(searched_bitmap_1.len(), 2);
//     }
...
//         let (query_parser, index) =
//             commit_some_docs_for_test(temp_directory_str.to_string(), false);
...
//         let tokenizer_with_parameter_cxx: &CxxString = tokenizer_with_parameter.as_ref().get_ref();
//         let index_directory_cxx: &CxxString = index_directory.as_ref().get_ref();
//         let index_writer_bridge_init = tantivy_create_index_with_tokenizer(
//             index_directory_cxx,
//             tokenizer_with_parameter_cxx,
//             false,
//         );
