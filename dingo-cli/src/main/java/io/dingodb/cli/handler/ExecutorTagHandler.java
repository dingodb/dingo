...
public class ExecutorTagHandler {

    public static void handler(String name, String tag, boolean delete) {
        ...
        if (delete) {
            helixAdmin.removeInstanceTag(clusterName, name, tag);
        } else {
            helixAdmin.addInstanceTag(clusterName, name, tag);
        }
