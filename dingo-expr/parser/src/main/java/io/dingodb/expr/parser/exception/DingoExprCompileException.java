...
public class DingoExprCompileException extends Exception {
     ...
     */
    public DingoExprCompileException(String message) {
        super(message);
    }
     ...
     */
    public DingoExprCompileException(Throwable cause) {
        super(cause);
    }
}
