...
public final class GeInt extends BoolBinaryEval {
    private static final long serialVersionUID = -7233927803021985792L;

    public GeInt(Eval operand0, Eval operand1) {
