...
public final class VarArgAndEval extends BoolVarArgEval {
    private static final long serialVersionUID = 2543368211982704693L;

    public VarArgAndEval(Eval[] operands) {
        super(operands);
    }
