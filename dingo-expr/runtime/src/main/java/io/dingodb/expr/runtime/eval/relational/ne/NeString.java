...
public final class NeString extends BoolBinaryEval {
    private static final long serialVersionUID = 4652634020797875355L;

    public NeString(Eval operand0, Eval operand1) {
