...
public final class IsFalseDouble extends BoolUnaryEval {
    private static final long serialVersionUID = 1248353090820514851L;

    public IsFalseDouble(Eval operand) {
        super(operand);
    }
