...
package io.dingodb.expr.runtime.eval.relational.eq;
...
public final class EqDouble extends BoolBinaryEval {
    private static final long serialVersionUID = 3110520981365696767L;

    public EqDouble(Eval operand0, Eval operand1) {
