...
package io.dingodb.expr.runtime.eval.relational.ne;
...
public final class NeDouble extends BoolBinaryEval {
    private static final long serialVersionUID = -3716006605524131145L;

    public NeDouble(Eval operand0, Eval operand1) {
