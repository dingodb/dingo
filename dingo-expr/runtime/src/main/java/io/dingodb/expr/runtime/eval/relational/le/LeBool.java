...
public final class LeBool extends BoolBinaryEval {
    private static final long serialVersionUID = -271264052329358425L;

    public LeBool(Eval operand0, Eval operand1) {
