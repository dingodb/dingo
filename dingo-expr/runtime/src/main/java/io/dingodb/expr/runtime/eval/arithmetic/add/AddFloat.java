...
public final class AddFloat extends FloatBinaryEval {
    private static final long serialVersionUID = -4322525928376704584L;

    public AddFloat(Eval operand0, Eval operand1) {
