...
public final class LtInt extends BoolBinaryEval {
    private static final long serialVersionUID = 2739432961325467318L;

    public LtInt(Eval operand0, Eval operand1) {
