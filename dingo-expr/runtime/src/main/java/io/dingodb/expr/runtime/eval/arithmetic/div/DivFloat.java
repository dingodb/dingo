...
public final class DivFloat extends FloatBinaryEval {
    private static final long serialVersionUID = 3072707900509021784L;

    public DivFloat(Eval operand0, Eval operand1) {
