...
public final class OrEval extends BoolBinaryEval {
    private static final long serialVersionUID = -5328575303907607047L;

    public OrEval(Eval operand0, Eval operand1) {
