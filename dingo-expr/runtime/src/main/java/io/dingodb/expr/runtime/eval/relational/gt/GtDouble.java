...
public final class GtDouble extends BoolBinaryEval {
    private static final long serialVersionUID = -7390801615700961846L;

    public GtDouble(Eval operand0, Eval operand1) {
