...
public final class MulFloat extends FloatBinaryEval {
    private static final long serialVersionUID = 1449248090415876002L;

    public MulFloat(Eval operand0, Eval operand1) {
