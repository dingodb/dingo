...
@Slf4j
public class DingoLikeBinaryOp extends RtFun {
    private final Pattern pattern;

    public DingoLikeBinaryOp() {
        super(null);
        pattern = null;
    }

    public DingoLikeBinaryOp(@Nonnull RtExpr[] paras) {
        super(paras);
    ...
    public static class Provider implements DingoFuncProvider {
        ...
        public Function<RtExpr[], RtOp> supplier() {
            return DingoLikeBinaryOp::new;
        }

        @Override
        public List<String> name() {
            return Arrays.asList("like_binary");
        }
        ...
        public List<Method> methods() {
            try {
                ...
                methods.add(DingoLikeBinaryOp.class.getMethod("likeBinary", String.class));
                return methods;
