...
public final class LtFloat extends BoolBinaryEval {
    private static final long serialVersionUID = -2721749922462669400L;

    public LtFloat(Eval operand0, Eval operand1) {
