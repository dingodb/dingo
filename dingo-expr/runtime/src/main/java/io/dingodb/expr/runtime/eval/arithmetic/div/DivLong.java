...
public final class DivLong extends LongBinaryEval {
    private static final long serialVersionUID = -1132529088993497735L;

    public DivLong(Eval operand0, Eval operand1) {
