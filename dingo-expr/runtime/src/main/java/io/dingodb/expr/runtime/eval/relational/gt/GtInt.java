...
public final class GtInt extends BoolBinaryEval {
    private static final long serialVersionUID = -4375651145521749255L;

    public GtInt(Eval operand0, Eval operand1) {
