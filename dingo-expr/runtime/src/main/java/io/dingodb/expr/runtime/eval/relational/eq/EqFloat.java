...
public final class EqFloat extends BoolBinaryEval {
    private static final long serialVersionUID = -6905062030544675252L;

    public EqFloat(Eval operand0, Eval operand1) {
