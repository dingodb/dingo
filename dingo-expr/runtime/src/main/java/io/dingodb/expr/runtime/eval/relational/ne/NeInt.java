...
public final class NeInt extends BoolBinaryEval {
    private static final long serialVersionUID = -3721289184857141347L;

    public NeInt(Eval operand0, Eval operand1) {
