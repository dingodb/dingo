...
public final class LtLong extends BoolBinaryEval {
    private static final long serialVersionUID = -4240680540366801475L;

    public LtLong(Eval operand0, Eval operand1) {
