...
public final class LeLong extends BoolBinaryEval {
    private static final long serialVersionUID = 5176802591337721932L;

    public LeLong(Eval operand0, Eval operand1) {
