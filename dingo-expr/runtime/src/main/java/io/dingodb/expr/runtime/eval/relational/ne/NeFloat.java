...
public final class NeFloat extends BoolBinaryEval {
    private static final long serialVersionUID = -4303374588355472595L;

    public NeFloat(Eval operand0, Eval operand1) {
