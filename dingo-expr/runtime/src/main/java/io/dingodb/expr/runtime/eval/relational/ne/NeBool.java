...
public final class NeBool extends BoolBinaryEval {
    private static final long serialVersionUID = -3099514055167243752L;

    public NeBool(Eval operand0, Eval operand1) {
