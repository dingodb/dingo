...
package io.dingodb.expr.runtime.eval.relational.le;
...
public final class LeString extends BoolBinaryEval {
    private static final long serialVersionUID = -3282124503079908632L;

    public LeString(Eval operand0, Eval operand1) {
