...
public final class GeLong extends BoolBinaryEval {
    private static final long serialVersionUID = -2710665099438730847L;

    public GeLong(Eval operand0, Eval operand1) {
