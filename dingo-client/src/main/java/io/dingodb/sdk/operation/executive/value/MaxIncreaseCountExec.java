...
import io.dingodb.sdk.operation.unit.numeric.MaxIncreaseCountUnit;
...
public class MaxIncreaseCountExec extends AbstractExecutive<Context, Iterator<Object[]>> {

    public static final CommonId COMMON_ID = new CommonId(CommonId.CommonType.OP, 0, 21);
    ...
    public DingoOpResult execute(Context context, Iterator<Object[]> records) {
        ...
        try {
            ...
            while (records.hasNext()) {
                ...
                NumberUnit unit = new MaxIncreaseCountUnit(convertType(record[keyIndex], dingoType));
