...
import io.dingodb.sdk.operation.unit.collection.DistinctListUnit;

import java.util.Iterator;

@AutoService(Executive.class)
public class DistinctListExec extends AbstractExecutive<Context, Iterator<Object[]>> {

    public static final CommonId COMMON_ID = new CommonId(CommonId.CommonType.OP, 0, 31);
    @Override
    ...
    public MultiValueOpResult execute(Context context, Iterator<Object[]> records) {
        ...
        DistinctListUnit unit = new DistinctListUnit<>();
        try {
