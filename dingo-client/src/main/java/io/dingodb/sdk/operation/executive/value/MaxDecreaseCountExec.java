...
public class MaxDecreaseCountExec extends AbstractExecutive<Context, Iterator<Object[]>> {

    public static final CommonId COMMON_ID = new CommonId(CommonId.CommonType.OP, 0, 20);
    ...
    public DingoOpResult execute(Context context, Iterator<Object[]> records) {
        ...
        try {
            ...
            while (records.hasNext()) {
                ...
                NumberUnit unit = new MaxDecreaseCountUnit(convertType(record[keyIndex], dingoType));
