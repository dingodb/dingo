...
public class IncreaseCountUnit<M extends IncreaseCountUnit<M>> extends BoundaryUnit<ComputeNumber, M> {

    public IncreaseCountUnit() {
    }

    public IncreaseCountUnit(ComputeNumber center) {
        super(center);
    }

    public IncreaseCountUnit(ComputeNumber head, ComputeNumber tail, ComputeLong value, long count) {
    ...
    @Override
    public M fastClone() {
        return (M) new IncreaseCountUnit(
