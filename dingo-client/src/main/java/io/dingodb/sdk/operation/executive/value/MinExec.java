...
import io.dingodb.sdk.operation.unit.numeric.MinUnit;
...
public class MinExec extends AbstractExecutive<Context, Iterator<Object[]>> {

    public static final CommonId COMMON_ID = new CommonId(CommonId.CommonType.OP, 0, 14);
    ...
    public DingoOpResult execute(Context context, Iterator<Object[]> records) {
        ...
        try {
            ...
            while (records.hasNext()) {
                ...
                NumberUnit unit = new MinUnit<>(convertType(record[keyIndex], dingoType), 1);
