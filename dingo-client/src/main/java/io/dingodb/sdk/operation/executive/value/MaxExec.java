...
import io.dingodb.sdk.operation.unit.numeric.MaxUnit;
...
public class MaxExec extends AbstractExecutive<Context, Iterator<Object[]>> {

    public static final CommonId COMMON_ID = new CommonId(CommonId.CommonType.OP, 0, 13);
    ...
    public ValueOpResult execute(Context context, Iterator<Object[]> records) {
        ...
        try {
            ...
            while (records.hasNext()) {
                ...
                NumberUnit unit = new MaxUnit(convertType(record[keyIndex], dingoType), 1);
