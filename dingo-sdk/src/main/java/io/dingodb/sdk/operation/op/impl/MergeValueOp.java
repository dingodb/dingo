...
public class MergeValueOp extends ValueOp {

    public MergeValueOp(CommonId execId, Context context) {
        super(execId, context);
    }

    public MergeValueOp(CommonId execId, Context context, Op head) {
