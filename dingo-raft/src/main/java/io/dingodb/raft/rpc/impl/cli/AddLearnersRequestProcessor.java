...
public class AddLearnersRequestProcessor extends BaseCliRequestProcessor<CliRequests.AddLearnersRequest> {
    ...
    @Override
    public CliRequests.AddLearnersRequest parse(byte[] request) {
        try {
            return CliRequests.AddLearnersRequest.parseFrom(request);
    ...
    public Tag getRequestTag() {
        return RaftTag.ADDLEARNERS_REQUEST;
    }

    @Override
    public Tag getResponseTag() {
        return RaftTag.ADDLEARNERS_RESPONSE;
    }
