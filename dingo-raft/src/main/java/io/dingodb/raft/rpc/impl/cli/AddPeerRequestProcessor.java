...
public class AddPeerRequestProcessor extends BaseCliRequestProcessor<CliRequests.AddPeerRequest> {
    ...
    @Override
    public CliRequests.AddPeerRequest parse(byte[] request) {
        try {
            return CliRequests.AddPeerRequest.parseFrom(request);
    ...
    public Tag getRequestTag() {
        return RaftTag.ADDPEER_REQUEST;
    }

    @Override
    public Tag getResponseTag() {
        return RaftTag.ADDPEER_RESPONSE;
    }
