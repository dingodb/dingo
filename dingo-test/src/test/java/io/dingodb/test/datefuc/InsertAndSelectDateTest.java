...
public class InsertAndSelectDateTest {
    ...
    public void testInsertDateAndFormatOutput() throws SQLException {
        ...
        String queryDFTSSql = "select name,date_format(update_Time,'%Y/%m/%d %H.%i.%s') ts_out from test where id<8";
        //String queryDFTSSql = "select birthday, createTime, update_Time from test where id<8";
    ...
    public void testInsertTime() throws SQLException {
        ...
        String insertSql = "insert into timetest values(1, 'zhang san', 18, 1342.09, '12345')";
