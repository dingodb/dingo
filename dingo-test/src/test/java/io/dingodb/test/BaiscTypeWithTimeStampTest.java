...
@Slf4j
public class BaiscTypeWithTimeStampTest {
    ...
    public static void setupAll() throws Exception {
        ...
        sqlHelper.execUpdate("/table-test-create-with-timestamp.sql");
    }
    ...
    public void setup() throws Exception {
        sqlHelper.execUpdate("/table-test-data-with-timestamp.sql");
    }
