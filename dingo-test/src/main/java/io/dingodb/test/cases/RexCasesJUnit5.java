...
public final class RexCasesJUnit5 implements ArgumentsProvider {
    private static @NonNull Arguments unixTimestampCase(@Nonnull String timestampStr) {
        ...
        return arguments(
            ...
            "UNIX_TIMESTAMP(CASTTIMESTAMP('" + timestampStr.replace("/", "\\/") + "'))",
    ...
    public @NonNull Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        return Stream.of(
            ...
            arguments("ceil(cast (3.6 as double))", "CEIL(CASTDOUBLE(3.6))", 4.0D),
            ...
            arguments("floor(cast (3.6 as double))", "FLOOR(CASTDOUBLE(3.6))", 3.0D),
            ...
            arguments("round(105, '-2')", "ROUND(105, CASTDECIMAL('-2'))", 100),
            arguments("round(10)", "ROUND(10)", 10),
            arguments("round(cast (3.6 as double), 0)", "ROUND(CASTDOUBLE(3.6), 0)", 4.0D),
            arguments("round(cast (3.4 as double))", "ROUND(CASTDOUBLE(3.4))", 3.0D),
            ...
            arguments("substring('DingoDatabase', 2, cast (2.5 as int))", "MID('DingoDatabase', 2, CASTINT(2.5))", "ing"),
            ...
            arguments("trim(123 from 1234123)", "TRIM(CASTSTRING(1234123), CASTSTRING(123))", "4"),
            ...
            arguments("123 like 'abc|\\%\\_' escape '|'", "MATCHES_NC(CASTSTRING(123), $CP('abc|\\\\%\\\\_', '|'))", false),
            arguments("123 like 'abc|\\%\\_'", "MATCHES_NC(CASTSTRING(123), $CP('abc|\\\\%\\\\_'))", false),
            ...
            // Date & times
            arguments("CAST('1970.1.2' AS DATE)", "CASTDATE('1970.1.2')", "1970-01-02"),
            arguments(
            ...
            arguments(
                ...
                "DATE_FORMAT(CASTDATE('1980-2-3'), $CTF('%Y:%m:%d'))",
                "1980:02:03"
            ),
            arguments(
                "DATE_FORMAT(CAST('2020/11/3' AS DATE), '%Y year, %m month %d day')",
                "DATE_FORMAT(CASTDATE('2020\\/11\\/3'), $CTF('%Y year, %m month %d day'))",
                "2020 year, 11 month 03 day"
            ),
            arguments(
                "DATE_FORMAT(CAST('2020.11.30' AS DATE), '%Y year, %m month')",
                "DATE_FORMAT(CASTDATE('2020.11.30'), $CTF('%Y year, %m month'))",
                "2020 year, 11 month"
            ),
            arguments("time_format('111213', '%H-%i.%s')", "TIME_FORMAT(CASTTIME('111213'), $CTF('%H-%i.%s'))", "11-12.13"),
            arguments("time_format('11:2:3', '%H.%i.%s')", "TIME_FORMAT(CASTTIME('11:2:3'), $CTF('%H.%i.%s'))", "11.02.03"),
            arguments("time_format('110203', '%H%i%S')", "TIME_FORMAT(CASTTIME('110203'), $CTF('%H%i%S'))", "110203"),
            arguments("time_format('083026', '%H.%i.%s')", "TIME_FORMAT(CASTTIME('083026'), $CTF('%H.%i.%s'))", "08.30.26"),
            arguments("time_format('000006', '%H.%i.%s')", "TIME_FORMAT(CASTTIME('000006'), $CTF('%H.%i.%s'))", "00.00.06"),
            arguments("time_format('180000', '%H.%i.%s')", "TIME_FORMAT(CASTTIME('180000'), $CTF('%H.%i.%s'))", "18.00.00"),
            arguments("time_format('23:59:59', '%H.%i.%s')", "TIME_FORMAT(CASTTIME('23:59:59'), $CTF('%H.%i.%s'))", "23.59.59"),
            arguments(
                "time_format('19:00:28.331', '%H.%i.%s.%f')",
                "TIME_FORMAT(CASTTIME('19:00:28.331'), $CTF('%H.%i.%s.%f'))",
                "19.00.28.331"
            ),
            arguments(
                "time_format('235959')",
                "TIME_FORMAT(CASTTIME('235959'))",
                "23:59:59"
            ),
            arguments(
                "time_format(cast ('23:11:25' as time), '%H-%i-%s')",
                "TIME_FORMAT(CASTTIME('23:11:25'), $CTF('%H-%i-%s'))",
                "23-11-25"
            ),
            arguments(
                "timestamp_format('1999/1/01 01:01:01', '%Y/%m/%d %T')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1999\\/1\\/01 01:01:01'), $CTF('%Y\\/%m\\/%d %T'))",
                "1999/01/01 01:01:01"
            ),
            arguments(
                "timestamp_format('1999.01.01 01:01:01', '%Y.%m.%d %T')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1999.01.01 01:01:01'), $CTF('%Y.%m.%d %T'))",
                "1999.01.01 01:01:01"
            ),
            arguments(
                "timestamp_format('19990101010101', '%Y%m%d %T')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('19990101010101'), $CTF('%Y%m%d %T'))",
                "19990101 01:01:01"
            ),
            arguments(
                "timestamp_format('20220413103706', '%Y/%m/%d %H:%i:%S')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('20220413103706'), $CTF('%Y\\/%m\\/%d %H:%i:%S'))",
                "2022/04/13 10:37:06"
            ),
            arguments(
                "timestamp_format('1999-01-01 01:01:01.22', '%Y/%m/%d %T.%f')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1999-01-01 01:01:01.22'), $CTF('%Y\\/%m\\/%d %T.%f'))",
                "1999/01/01 01:01:01.220"
            ),
            arguments(
                "timestamp_format('2022-04-13 10:37:26', '%Ss')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2022-04-13 10:37:26'), $CTF('%Ss'))",
                "26s"
            ),
            arguments(
                "timestamp_format('1999-01-01 10:37:26', '%Y year %m month %d day and %s seconds')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1999-01-01 10:37:26'), $CTF('%Y year %m month %d day and %s seconds'))",
                "1999 year 01 month 01 day and 26 seconds"
            ),
            arguments(
                "timestamp_format('2022-04-13 10:37:26', '%m mon %d day %Y year, %H hour %i min %S sec')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2022-04-13 10:37:26'),"
            ...
            arguments(
                ...
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2022-04-13 10:37:36'), $CTF('%H:%i:%S'))",
                "10:37:36"
            ),
            arguments(
                "timestamp_format('20220413103726', 'Year:%Y Month:%m Day:%d')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('20220413103726'), $CTF('Year:%Y Month:%m Day:%d'))",
                "Year:2022 Month:04 Day:13"
            ),
            arguments(
                "timestamp_format('2022/07/22 12:00:00')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2022\\/07\\/22 12:00:00'))",
                "2022-07-22 12:00:00"
            ),
            arguments(
                "timestamp_format(cast ('1980-2-3 23:11:25' as timestamp), 'Date: %Y%m%d Time: %T')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1980-2-3 23:11:25'), $CTF('Date: %Y%m%d Time: %T'))",
                "Date: 19800203 Time: 23:11:25"
            ),
            arguments(
                "timestamp_format(cast ('1980-2-3 23:11:25' as timestamp), '%Y%m%d %T')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('1980-2-3 23:11:25'), $CTF('%Y%m%d %T'))",
                "19800203 23:11:25"
            ),
            arguments(
                "TIMESTAMP_FORMAT(CAST('2020.11.30 9:1:1' AS TIMESTAMP), '%Y year, %m month')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2020.11.30 9:1:1'), $CTF('%Y year, %m month'))",
                "2020 year, 11 month"
            ),
            arguments(
                "TIMESTAMP_FORMAT(CAST('2020.11.30 01:1:01' AS TIMESTAMP), '%Y year, %m month')",
                "TIMESTAMP_FORMAT(CASTTIMESTAMP('2020.11.30 01:1:01'), $CTF('%Y year, %m month'))",
                "2020 year, 11 month"
            ),
            arguments(
                "TIMESTAMP_FORMAT(CAST('2020/11/30 01:1:01' AS TIMESTAMP), '%Y year, %m month')",
            ...
            arguments("datediff('2007-12-29', '2007-12-30')",
                "DATEDIFF(CASTDATE('2007-12-29'), CASTDATE('2007-12-30'))", -1L),
            arguments("datediff('2007-12-29', '2007-12-30')",
                "DATEDIFF(CASTDATE('2007-12-29'), CASTDATE('2007-12-30'))", -1L),
            arguments("datediff('2022-04-14', '2022-05-31')",
                "DATEDIFF(CASTDATE('2022-04-14'), CASTDATE('2022-05-31'))", -47L),
            arguments("datediff('2022-04-30', '2022-05-01')",
                "DATEDIFF(CASTDATE('2022-04-30'), CASTDATE('2022-05-01'))", -1L),
            arguments("datediff('2022-04-30', '2022-05-31')",
                "DATEDIFF(CASTDATE('2022-04-30'), CASTDATE('2022-05-31'))", -31L),
            arguments("datediff('2022-05-31', '2022-04-13')",
                "DATEDIFF(CASTDATE('2022-05-31'), CASTDATE('2022-04-13'))", 48L),
            arguments("datediff('2022-05-31', '2022-05-01')",
                "DATEDIFF(CASTDATE('2022-05-31'), CASTDATE('2022-05-01'))", 30L),
            arguments("datediff('', '')", "DATEDIFF(CASTDATE(''), CASTDATE(''))", null),
