...
fn main() {
    ...
    let cat_regex_result = searcher
        .search(&cat_regex_query, &Count)
        .expect("failed to search");
    let bigger_regex_result = searcher
        .search(&bigger_regex_query, &Count)
        .expect("failed to search");
    let percent_regex_result = searcher
        .search(&percent_regex_query, &Count)
        .expect("failed to search");
