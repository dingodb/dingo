...
@JsonTypeName("bit")
public class BitType extends AbstractScalarType {
    @JsonCreator
    public BitType(@JsonProperty("nullable") boolean nullable) {
        super(Types.LONG, nullable);
    }

    @Override
    public BitType copy() {
        return new BitType(nullable);
    }
