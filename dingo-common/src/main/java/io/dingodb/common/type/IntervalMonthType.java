...
public class IntervalMonthType extends NullableType {
    ...
    public IntervalMonthType(boolean nullable, Type element) {
        super(nullable);
        this.element = element;
        this.type = Types.INTERVAL_MONTH;
    }

    @Override
    public DingoType copy() {
        return new IntervalMonthType(nullable, type);
    }
