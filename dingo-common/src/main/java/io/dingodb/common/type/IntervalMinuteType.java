...
@JsonTypeName("interval_minute")
@JsonPropertyOrder({"type", "nullable"})
@EqualsAndHashCode(of = {"type"}, callSuper = true)
public class IntervalMinuteType extends NullableType {
    ...
    @JsonCreator
    public IntervalMinuteType(boolean nullable, Type element) {
        super(nullable);
        this.type = Types.INTERVAL_MINUTE;
        this.element = element;
    }

    @Override
    public DingoType copy() {
        return new IntervalMinuteType(nullable, element);
    }
