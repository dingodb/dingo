...
@JsonTypeName("interval_second")
@JsonPropertyOrder({"type", "nullable"})
@EqualsAndHashCode(of = {"type"}, callSuper = true)
public class IntervalSecondType extends NullableType {
    ...
    @JsonCreator
    public IntervalSecondType(boolean nullable, Type element) {
        super(nullable);
        this.type = Types.INTERVAL_SECOND;
        this.element = element;
    }

    @Override
    public DingoType copy() {
        return new IntervalSecondType(nullable, element);
    }
