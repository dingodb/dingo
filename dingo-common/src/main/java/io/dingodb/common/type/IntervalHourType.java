...
@JsonTypeName("interval_hour")
@JsonPropertyOrder({"type", "nullable"})
@EqualsAndHashCode(of = {"type"}, callSuper = true)
public class IntervalHourType extends NullableType {
    ...
    @JsonCreator
    public IntervalHourType(boolean nullable, Type element) {
        super(nullable);
        this.type = Types.INTERVAL_HOUR;
        this.element = element;
    }

    @Override
    public DingoType copy() {
        return new IntervalHourType(nullable, element);
    }
