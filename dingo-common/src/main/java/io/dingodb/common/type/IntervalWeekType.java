...
@JsonTypeName("interval_week")
@JsonPropertyOrder({"type, nullable"})
@EqualsAndHashCode(of = {"type"},  callSuper = true)
public class IntervalWeekType extends NullableType {
    ...
    @JsonCreator
    public IntervalWeekType(boolean nullable, Type element) {
        super(nullable);
        this.type = Types.INTERVAL_WEEK;
        this.element = element;
    }

    @Override
    public DingoType copy() {
        return new IntervalWeekType(nullable, element);
    }
