...
public class SqlLikeUtils {
     ...
     * @return true or false
     */
    public static boolean similar(String str, String pattern) {
     ...
     * @return true or false
     */
    public static boolean similar(String str, String pattern, String escape) {
    ...
    public static RuntimeException invalidEscapeCharacter(String str) {
        return new RuntimeException("Invalid escape character '" + str + "'");
    }

    public static RuntimeException invalidEscapeSequence(String str, int index) {
        return new RuntimeException("Invalid escape sequence '" + str + "', " + index);
    }
    ...
    private static RuntimeException invalidRegularExpression(String pattern, int index) {
