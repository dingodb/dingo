...
import io.dingodb.dingokv.errors.NeverGetHereException;
...
public final class FutureHelper {
    public static final long DEFAULT_TIMEOUT_MILLIS = SystemPropertyUtil.getLong("dingo.default_future_timeout", 10000);
