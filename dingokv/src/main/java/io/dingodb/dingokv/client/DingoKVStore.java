...
public interface DingoKVStore extends Lifecycle<DingoKVStoreOptions> {
    /**
     ...
     */
    DingoKVIterator<KVEntry> iterator(final byte[] startKey, final byte[] endKey, final int bufSize);

    /**
     * @see #iterator(byte[], byte[], int)
     */
    DingoKVIterator<KVEntry> iterator(final String startKey, final String endKey, final int bufSize);
