...
import static io.dingodb.dingokv.metrics.KVMetricNames.RPC_REQUEST_HANDLE_TIMER;
import static io.dingodb.dingokv.storage.KVOperation.COMPARE_PUT;
import static io.dingodb.dingokv.storage.KVOperation.COMPARE_PUT_ALL;
import static io.dingodb.dingokv.storage.KVOperation.CONTAINS_KEY;
import static io.dingodb.dingokv.storage.KVOperation.DELETE;
import static io.dingodb.dingokv.storage.KVOperation.DELETE_LIST;
import static io.dingodb.dingokv.storage.KVOperation.DELETE_RANGE;
import static io.dingodb.dingokv.storage.KVOperation.GET;
import static io.dingodb.dingokv.storage.KVOperation.GET_PUT;
import static io.dingodb.dingokv.storage.KVOperation.GET_SEQUENCE;
import static io.dingodb.dingokv.storage.KVOperation.KEY_LOCK;
import static io.dingodb.dingokv.storage.KVOperation.KEY_LOCK_RELEASE;
import static io.dingodb.dingokv.storage.KVOperation.MERGE;
import static io.dingodb.dingokv.storage.KVOperation.MULTI_GET;
import static io.dingodb.dingokv.storage.KVOperation.NODE_EXECUTE;
import static io.dingodb.dingokv.storage.KVOperation.PUT;
import static io.dingodb.dingokv.storage.KVOperation.PUT_IF_ABSENT;
import static io.dingodb.dingokv.storage.KVOperation.PUT_LIST;
import static io.dingodb.dingokv.storage.KVOperation.RESET_SEQUENCE;
import static io.dingodb.dingokv.storage.KVOperation.REVERSE_SCAN;
import static io.dingodb.dingokv.storage.KVOperation.SCAN;
