...
package io.dingodb.dingokv.serialization.impl.protostuff.io;
...
import io.dingodb.dingokv.util.VarInts;
...
class NioBufOutput implements Output {
    private static final ReferenceFieldUpdater<ByteString, byte[]> byteStringBytesGetter
