...
public class NonBlockingHashMapLong<V> extends AbstractMap<Long, V> implements ConcurrentMap<Long, V>,
                                                                           Serializable {
     ...
     * @throws NullPointerException if the specified value is null
     */
    public V replace(long key, V val) {
    ...
    private V putIfMatch(long key, Object newVal, Object oldVal) {
    ...
    private class NBHMLEntry extends AbstractEntry<Long, V> {
        NBHMLEntry(final Long k, final V v) {
            super(k, v);
        }
    ...
    private void writeObject(java.io.ObjectOutputStream s) throws IOException {
        ...
        for (long K : keySet()) {
            ...
            s.writeLong(K); // Write the <long,V> pair
            s.writeObject(V);
        }
