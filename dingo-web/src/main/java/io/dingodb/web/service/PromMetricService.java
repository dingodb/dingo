...
public class PromMetricService {
    ...
    public void loadMetric(long currentTimeSeconds) {
        cpuIdleMap.clear();
    ...
    public double getMemUsage(String instance) {
        ...
        return  (TMP1.subtract(available.divide(total, 2, RoundingMode.HALF_UP))).multiply(TMP2).doubleValue();
    }
    ...
    public ProcessInfo getProcessMetric(String instance) {
        ...
        double dataStackMem = processDataStackMemMap.getOrDefault(instance, ZERO).doubleValue();
        double residentMem = processResidentMemMap.getOrDefault(instance, ZERO).doubleValue();
        double sharedMem = processSharedMemMap.getOrDefault(instance, ZERO).doubleValue();
        double txtMem = processTxtMemMap.getOrDefault(instance, ZERO).doubleValue();
        double virtualMem = processVirtualMemMap.getOrDefault(instance, ZERO).doubleValue();
    ...
    public long getNonHeap(String instance) {
        return jvmNonHeapMap.getOrDefault(instance, ZERO).longValue();
    }

    public ResourceExecutorInfo getResourceExecutorInfo(String instance,
                                                        ResourceInfo resourceInfo) {
        double jvmUsage = getJvmUsage(instance);
        long nonHeap = getNonHeap(instance);
