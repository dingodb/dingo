...
@Getter
@JsonTypeName("rollBackPessimisticLock")
@JsonPropertyOrder({"isolationLevel", "startTs", "forUpdateTs", "schema"})
public class PessimisticRollBackParam extends AbstractParams {
    ...
    public PessimisticRollBackParam(
