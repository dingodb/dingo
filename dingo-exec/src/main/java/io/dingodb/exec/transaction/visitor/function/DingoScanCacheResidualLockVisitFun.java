...
public class DingoScanCacheResidualLockVisitFun {

    public static Collection<Vertex> visit(
        Job job, IdGenerator idGenerator, Location currentLocation, ITransaction transaction,
        DingoTransactionRenderJob visitor, ScanCacheResidualLockLeaf scanCacheResidualLockLeaf) {
        ...
        for (Map.Entry<CommonId, Channel> channelEntry : channelMap.entrySet()) {
            ...
            ScanCacheResidualLockParam param = new ScanCacheResidualLockParam(dingoType, transaction.getType());
