...
public class DingoScanCleanExtraDataCacheVisitFun {

    public static Collection<Vertex> visit(
        Job job, IdGenerator idGenerator, Location currentLocation, ITransaction transaction,
        DingoTransactionRenderJob visitor, ScanCleanExtraDataCacheLeaf scanCleanCacheLeaf) {
        ...
        for (Map.Entry<CommonId, Channel> channelEntry : channelMap.entrySet()) {
            ...
            ScanCleanExtraDataCacheParam param = new ScanCleanExtraDataCacheParam(dingoType, transaction.getType());
