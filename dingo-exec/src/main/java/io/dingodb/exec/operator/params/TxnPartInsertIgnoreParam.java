...
@Getter
@JsonTypeName("txn_insert_ignore")
@JsonPropertyOrder({"pessimisticTxn", "isolationLevel", "primaryLockKey", "lockTimeOut",
    "checkInPlace", "startTs", "forUpdateTs", "table", "schema"})
public class TxnPartInsertIgnoreParam extends TxnPartModifyParam {
    ...
    public TxnPartInsertIgnoreParam(
