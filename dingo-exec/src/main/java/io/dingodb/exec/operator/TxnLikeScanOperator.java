...
import io.dingodb.exec.operator.params.TxnLikeScanParam;
...
@Slf4j
public final class TxnLikeScanOperator extends FilterProjectSourceOperator {
    public static final TxnLikeScanOperator INSTANCE = new TxnLikeScanOperator();

    private TxnLikeScanOperator() {
    }

    @Override
    protected @NonNull Iterator<Object[]> createSourceIterator(Vertex vertex) {
        TxnLikeScanParam param = vertex.getParam();
