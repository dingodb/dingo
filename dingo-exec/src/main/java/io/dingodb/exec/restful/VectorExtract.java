...
public class VectorExtract {
    ...
    static {
        vectorInterface.put(VectorImageFun.NAME, new RestfulRequest("", null, "GET", ""));
        vectorInterface.put(VectorTextFun.NAME,
            new RestfulRequest("http://host:8080/embedding/", null, "GET", ""));
    }
    ...
    public static Float[] getVector(String funName, String host, Object param) {
        ...
        request.setParam(param.toString());
