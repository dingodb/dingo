...
import io.dingodb.exec.operator.ListTransientScanOperator;
...
import io.dingodb.exec.operator.PessimisticLockInsertIgnoreOperator;
import io.dingodb.exec.operator.PessimisticLockInsertOperator;
import io.dingodb.exec.operator.PessimisticLockOperator;
import io.dingodb.exec.operator.PessimisticLockReplaceIntoOperator;
...
import io.dingodb.exec.operator.RepeatUnionOperator;
...
import io.dingodb.exec.operator.TableSpoolOperator;
import io.dingodb.exec.operator.TxnAutoCommitInsertOperator;
...
import io.dingodb.exec.operator.TxnPartInsertIgnoreOperator;
...
import io.dingodb.exec.operator.TxnPartReplaceIntoOperator;
...
import static io.dingodb.exec.utils.OperatorCodeUtils.PESSIMISTIC_LOCK_REPLACE_INTO;
...
import static io.dingodb.exec.utils.OperatorCodeUtils.TABLE_SPOOL;
...
import static io.dingodb.exec.utils.OperatorCodeUtils.TXN_PART_REPLACE_INTO;
...
public final class OperatorFactory {
    ...
    static {
        ...
        OPERATORS.put(TXN_PART_REPLACE_INTO, TxnPartReplaceIntoOperator.INSTANCE);
        OPERATORS.put(TXN_PART_INSERT_IGNORE, TxnPartInsertIgnoreOperator.INSTANCE);
        OPERATORS.put(TXN_AUTOCOMMIT_INSERT, TxnAutoCommitInsertOperator.INSTANCE);
        ...
        OPERATORS.put(PESSIMISTIC_LOCK_REPLACE_INTO, PessimisticLockReplaceIntoOperator.INSTANCE);
        OPERATORS.put(PESSIMISTIC_LOCK_INSERT_IGNORE, PessimisticLockInsertIgnoreOperator.INSTANCE);
