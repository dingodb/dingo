...
package io.dingodb.exec.fun.document;
...
public class DocumentmageFun extends TertiaryOp {
    public static final DocumentmageFun INSTANCE = new DocumentmageFun();

    public static final String NAME = "img2vec";

    private static final long serialVersionUID = 2796411347891525563L;

    private DocumentmageFun() {
    }
    ...
    protected Object evalNonNullValue(
        ...
        Float[] vector = VectorExtract.getImgVector(DocumentmageFun.NAME, (String) value0, value1, (Boolean) value2);
