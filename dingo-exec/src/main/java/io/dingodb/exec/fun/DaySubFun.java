...
public class DaySubFun extends BinaryOp {
    @Serial
    private static final long serialVersionUID = -1914862455684545159L;

    public static final DaySubFun INSTANCE = new DaySubFun();

    public static final String NAME = "DAYSUB";
