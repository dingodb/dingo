...
public class CoordinatorFollowerService extends AbstractFollowerService {

    private final NetService netService;

    public CoordinatorFollowerService(StateServiceContext context, NetService netService) {
        super(context);
