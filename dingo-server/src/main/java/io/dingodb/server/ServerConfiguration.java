...
import static io.dingodb.helix.part.HelixPart.StateMode.LEADER_FOLLOWER;
...
public class ServerConfiguration {
    ...
    private static final String EXECUTOR_PORT_KEY = "server.executor.port";
    ...
    private static final String ROCKSDB = "io.dingodb.store.rocks.RocksStoreServiceProvider";
    ...
    public String stateMode() {
        return getString(STATE_MODE_KEY, LEADER_FOLLOWER.name);
    }
}
