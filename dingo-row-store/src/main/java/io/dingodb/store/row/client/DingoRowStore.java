...
public interface DingoRowStore extends Lifecycle<DingoRowStoreOptions> {
    /**
     ...
     */
    DingoRowStoreIterator<KVEntry> iterator(final byte[] startKey, final byte[] endKey, final int bufSize);

    /**
     * @see #iterator(byte[], byte[], int)
     */
    DingoRowStoreIterator<KVEntry> iterator(final String startKey, final String endKey, final int bufSize);
